              ...
              <div className='mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center'>
                <div className='w-full max-w-xl lg:shrink-0 xl:max-w-2xl'>
                  <h1 className='text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl'>
                    We&apos;re simplifying the student housing search.
                  </h1>
                  <p className='relative mt-6 text-lg leading-8 text-gray-600 sm:max-w-md lg:max-w-none'>
                    StudentStay is a revolutionary platform designed to provide easy-to-find,
                    affordable, and flexible housing options for students. The platform offers a
                    diverse range of shorter-term leasing opportunities that cater to the needs and
                    budgets of students, making it easy for them to find the perfect accommodation.
                    The platform brings together available properties from both building managers
                    and students, providing a comprehensive selection of options.
                  </p>
