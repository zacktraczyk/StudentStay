...
export default function CreateAccountModal({ open, setOpen }: CheckEmailModalProps) {
            ...
            >
              <Dialog.Panel className='relative overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm sm:p-6'>
                  ...
                  <div className='mt-3 text-center sm:mt-5'>
                    ...
                    <div className='mt-2'>
                      <p className='text-sm text-gray-500'>
                        Please create an account to save your favorite listings
                      </p>
                    </div>
                  </div>
                </div>
                <div className='mt-5 flex sm:mt-6'>
                  ...
                  <button
                    type='button'
                    className='flex w-full justify-center gap-2 px-3 py-2 text-sm font-semibold'
