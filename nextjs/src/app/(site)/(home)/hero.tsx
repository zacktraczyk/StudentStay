...
import FindListingsBlurb from './find-listings-blurb'
      ...
      <div className='mx-auto max-w-2xl py-32 sm:py-40'>
        ...
        <div className='text-center'>
          <h1 className='text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl'>
            Connecting students to apartments
          </h1>
          <p className='mt-6 text-lg leading-8 text-gray-600'>
            We provide a platform for students to find apartments and connect with other students.
            Browse listings and match with potential roommates.
          </p>
