export default function NewsletterSignup() {
  return (
    <div className='bg-white py-16 sm:py-44'>
      <div className='mx-auto grid max-w-7xl grid-cols-1 gap-10 px-6 lg:grid-cols-12 lg:gap-8 lg:px-8'>
        ...
        <form className='w-full max-w-md lg:col-span-5 lg:pt-2'>
          <div className='flex gap-x-4'>
            ...
            <button
              type='submit'
              className='flex-none rounded-md bg-green-800 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-green-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-800'
            >
              Subscribe
            </button>
          </div>
